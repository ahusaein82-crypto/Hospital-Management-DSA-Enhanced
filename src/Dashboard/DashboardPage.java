...
public class DashboardPage extends javax.swing.JFrame {
    ...
    public DashboardPage() {
        ...
        gridLayout.add(new GridBox("src/Images/doctor.png", "Doctors"));
        gridLayout.add(new GridBox("src/Images/patient.png", "Pateints"));
        gridLayout.add(new GridBox("src/Images/appointment.png", "Appointment"));
        gridLayout.add(new GridBox("src/Images/medicine.png", "Medicines"));
        gridLayout.add(new GridBox("src/Images/seo-report.png", "Algorithms"));
